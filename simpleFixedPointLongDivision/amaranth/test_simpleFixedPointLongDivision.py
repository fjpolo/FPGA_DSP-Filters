...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to simpleFixedPointLongDivision() in simpleFixedPointLongDivision.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your simpleFixedPointLongDivision.v for the exact path:
    ...
    # For a simple simpleFixedPointLongDivision, dut.count.value *might* work, depending on Verilator's flattening.
