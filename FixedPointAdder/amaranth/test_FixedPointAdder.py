...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to FixedPointAdder() in FixedPointAdder.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your FixedPointAdder.v for the exact path:
    ...
    # For a simple FixedPointAdder, dut.count.value *might* work, depending on Verilator's flattening.
