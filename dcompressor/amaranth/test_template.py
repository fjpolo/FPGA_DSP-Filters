...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to dcompressor() in dcompressor.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your dcompressor.v for the exact path:
    ...
    # For a simple dcompressor, dut.count.value *might* work, depending on Verilator's flattening.
