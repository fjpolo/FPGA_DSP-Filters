...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to longDivision() in longDivision.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your longDivision.v for the exact path:
    ...
    # For a simple longDivision, dut.count.value *might* work, depending on Verilator's flattening.
