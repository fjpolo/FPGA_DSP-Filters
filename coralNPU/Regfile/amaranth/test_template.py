...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to Regfile() in Regfile.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your Regfile.v for the exact path:
    ...
    # For a simple Regfile, dut.count.value *might* work, depending on Verilator's flattening.
