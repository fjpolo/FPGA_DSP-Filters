...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to CircularBufferMulti() in CircularBufferMulti.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your CircularBufferMulti.v for the exact path:
    ...
    # For a simple CircularBufferMulti, dut.count.value *might* work, depending on Verilator's flattening.
