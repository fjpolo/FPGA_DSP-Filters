...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to RVDSPCoProc() in RVDSPCoProc.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your RVDSPCoProc.v for the exact path:
    ...
    # For a simple RVDSPCoProc, dut.count.value *might* work, depending on Verilator's flattening.
