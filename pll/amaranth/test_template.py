...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to pll() in pll.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your pll.v for the exact path:
    ...
    # For a simple pll, dut.count.value *might* work, depending on Verilator's flattening.
