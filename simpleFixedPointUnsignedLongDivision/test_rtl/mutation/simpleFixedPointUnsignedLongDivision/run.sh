    ...
    \`define MCY' simpleFixedPointUnsignedLongDivision.v > simpleFixedPointUnsignedLongDivision_temp.v

    #replace the orginal testbench file with the temp file.
    mv simpleFixedPointUnsignedLongDivision_temp.v simpleFixedPointUnsignedLongDivision.v

    # Copy simpleFixedPointUnsignedLongDivision here
    cp ${PWD}/../../simulation/icarus/simpleFixedPointUnsignedLongDivision/testbench.v .
