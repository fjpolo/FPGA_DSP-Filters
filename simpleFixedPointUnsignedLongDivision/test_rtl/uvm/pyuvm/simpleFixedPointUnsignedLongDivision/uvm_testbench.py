...
class simpleFixedPointUnsignedLongDivisionDriver(uvm_driver):
...
class simpleFixedPointUnsignedLongDivisionMonitor(uvm_monitor):
...
class simpleFixedPointUnsignedLongDivisionAgent(uvm_agent):
    def build_phase(self):
        self.monitor = simpleFixedPointUnsignedLongDivisionMonitor.create("monitor", self)
        self.driver = simpleFixedPointUnsignedLongDivisionDriver.create("driver", self)
        self.sequencer = uvm_sequencer("sequencer", self)
        
    def connect_phase(self):
        self.driver.seq_item_port.connect(self.sequencer.seq_item_export)

class simpleFixedPointUnsignedLongDivisionScoreboard(uvm_scoreboard):
    def build_phase(self):
...
class simpleFixedPointUnsignedLongDivisionEnv(uvm_env):
    def build_phase(self):
        self.agent = simpleFixedPointUnsignedLongDivisionAgent.create("agent", self)
        self.scoreboard = simpleFixedPointUnsignedLongDivisionScoreboard.create("scoreboard", self)
...
class simpleFixedPointUnsignedLongDivisionTest(uvm_test):
    def build_phase(self):
        self.env = simpleFixedPointUnsignedLongDivisionEnv.create("env", self)
...
async def run_test(dut):
    await uvm_root().run_test("simpleFixedPointUnsignedLongDivisionTest")