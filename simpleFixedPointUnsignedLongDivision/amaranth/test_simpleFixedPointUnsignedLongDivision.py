...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to simpleFixedPointUnsignedLongDivision() in simpleFixedPointUnsignedLongDivision.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your simpleFixedPointUnsignedLongDivision.v for the exact path:
    ...
    # For a simple simpleFixedPointUnsignedLongDivision, dut.count.value *might* work, depending on Verilator's flattening.
