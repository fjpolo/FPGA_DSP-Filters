...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to lcompressor() in lcompressor.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your lcompressor.v for the exact path:
    ...
    # For a simple lcompressor, dut.count.value *might* work, depending on Verilator's flattening.
