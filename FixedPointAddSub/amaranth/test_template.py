...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to FixedPointAddSub() in FixedPointAddSub.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your FixedPointAddSub.v for the exact path:
    ...
    # For a simple FixedPointAddSub, dut.count.value *might* work, depending on Verilator's flattening.
