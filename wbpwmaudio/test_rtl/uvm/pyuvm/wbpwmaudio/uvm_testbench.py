...
class wbpwmaudioDriver(uvm_driver):
...
class wbpwmaudioMonitor(uvm_monitor):
...
class wbpwmaudioAgent(uvm_agent):
    def build_phase(self):
        self.monitor = wbpwmaudioMonitor.create("monitor", self)
        self.driver = wbpwmaudioDriver.create("driver", self)
        self.sequencer = uvm_sequencer("sequencer", self)
        
    def connect_phase(self):
        self.driver.seq_item_port.connect(self.sequencer.seq_item_export)

class wbpwmaudioScoreboard(uvm_scoreboard):
    def build_phase(self):
...
class wbpwmaudioEnv(uvm_env):
    def build_phase(self):
        self.agent = wbpwmaudioAgent.create("agent", self)
        self.scoreboard = wbpwmaudioScoreboard.create("scoreboard", self)
...
class wbpwmaudioTest(uvm_test):
    def build_phase(self):
        self.env = wbpwmaudioEnv.create("env", self)
...
async def run_test(dut):
    await uvm_root().run_test("wbpwmaudioTest")