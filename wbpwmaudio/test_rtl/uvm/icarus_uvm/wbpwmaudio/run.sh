...
cp ${PWD}/../../../../rtl/wbpwmaudio.v .

# Build and run icaris UVM
iverilog -g2012 -I/path/to/uvm-1.2/src -D UVM_NO_DEPRECATED -o simv tb_top.sv dut_wrapper.sv wbpwmaudio.v
vvp -n simv +UVM_TESTNAME=wbpwmaudio_test +UVM_VERBOSITY=UVM_MEDIUM
