    ...
    cp ${PWD}/../../../rtl/simpleFixedPointLongDivision.v .

    # Append `define MCY after `timescale 1ps/1ps
    sed '/\`timescale 1ps\/1ps/a \
    \`define MCY' simpleFixedPointLongDivision.v > simpleFixedPointLongDivision_temp.v

    #replace the orginal testbench file with the temp file.
    mv simpleFixedPointLongDivision_temp.v simpleFixedPointLongDivision.v

    # Copy simpleFixedPointLongDivision here
    cp ${PWD}/../../simulation/icarus/simpleFixedPointLongDivision/testbench.v .
    ...
    # Copy original rtl here
    rm simpleFixedPointLongDivision.v