...
class simpleFixedPointLongDivisionDriver(uvm_driver):
...
class simpleFixedPointLongDivisionMonitor(uvm_monitor):
...
class simpleFixedPointLongDivisionAgent(uvm_agent):
    def build_phase(self):
        self.monitor = simpleFixedPointLongDivisionMonitor.create("monitor", self)
        self.driver = simpleFixedPointLongDivisionDriver.create("driver", self)
        self.sequencer = uvm_sequencer("sequencer", self)
        
    def connect_phase(self):
        self.driver.seq_item_port.connect(self.sequencer.seq_item_export)

class simpleFixedPointLongDivisionScoreboard(uvm_scoreboard):
    def build_phase(self):
...
class simpleFixedPointLongDivisionEnv(uvm_env):
    def build_phase(self):
        self.agent = simpleFixedPointLongDivisionAgent.create("agent", self)
        self.scoreboard = simpleFixedPointLongDivisionScoreboard.create("scoreboard", self)
...
class simpleFixedPointLongDivisionTest(uvm_test):
    def build_phase(self):
        self.env = simpleFixedPointLongDivisionEnv.create("env", self)
...
async def run_test(dut):
    await uvm_root().run_test("simpleFixedPointLongDivisionTest")