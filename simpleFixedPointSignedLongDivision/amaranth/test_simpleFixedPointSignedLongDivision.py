...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to simpleFixedPointSignedLongDivision() in simpleFixedPointSignedLongDivision.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your simpleFixedPointSignedLongDivision.v for the exact path:
    ...
    # For a simple simpleFixedPointSignedLongDivision, dut.count.value *might* work, depending on Verilator's flattening.
