    ...
    cp ${PWD}/../../../rtl/simpleFixedPointSignedLongDivision.v .

    # Append `define MCY after `timescale 1ps/1ps
    sed '/\`timescale 1ps\/1ps/a \
    \`define MCY' simpleFixedPointSignedLongDivision.v > simpleFixedPointSignedLongDivision_temp.v

    #replace the orginal testbench file with the temp file.
    mv simpleFixedPointSignedLongDivision_temp.v simpleFixedPointSignedLongDivision.v

    # Copy simpleFixedPointSignedLongDivision here
    cp ${PWD}/../../simulation/icarus/simpleFixedPointSignedLongDivision/testbench.v .
    ...
    # Copy original rtl here
    rm simpleFixedPointSignedLongDivision.v