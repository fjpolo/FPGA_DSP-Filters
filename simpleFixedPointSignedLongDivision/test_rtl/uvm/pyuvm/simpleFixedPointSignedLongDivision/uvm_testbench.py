...
class simpleFixedPointSignedLongDivisionDriver(uvm_driver):
...
class simpleFixedPointSignedLongDivisionMonitor(uvm_monitor):
...
class simpleFixedPointSignedLongDivisionAgent(uvm_agent):
    def build_phase(self):
        self.monitor = simpleFixedPointSignedLongDivisionMonitor.create("monitor", self)
        self.driver = simpleFixedPointSignedLongDivisionDriver.create("driver", self)
        self.sequencer = uvm_sequencer("sequencer", self)
        
    def connect_phase(self):
        self.driver.seq_item_port.connect(self.sequencer.seq_item_export)

class simpleFixedPointSignedLongDivisionScoreboard(uvm_scoreboard):
    def build_phase(self):
...
class simpleFixedPointSignedLongDivisionEnv(uvm_env):
    def build_phase(self):
        self.agent = simpleFixedPointSignedLongDivisionAgent.create("agent", self)
        self.scoreboard = simpleFixedPointSignedLongDivisionScoreboard.create("scoreboard", self)
...
class simpleFixedPointSignedLongDivisionTest(uvm_test):
    def build_phase(self):
        self.env = simpleFixedPointSignedLongDivisionEnv.create("env", self)
...
async def run_test(dut):
    await uvm_root().run_test("simpleFixedPointSignedLongDivisionTest")