...
# Input files
ORIGINAL_FILE="${PWD}/../../../rtl/simpleFixedPointSignedLongDivision.v"
FORMAL_FILE="properties.v"
CONFIG_FILE="simpleFixedPointSignedLongDivision.sby"

# Generate a timestamp for the temporary file
TEMP_FILE="simpleFixedPointSignedLongDivision_formal.v"
echo -n > $TEMP_FILE
