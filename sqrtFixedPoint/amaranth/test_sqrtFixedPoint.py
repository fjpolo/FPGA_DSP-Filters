...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to sqrtFixedPoint() in sqrtFixedPoint.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your sqrtFixedPoint.v for the exact path:
    ...
    # For a simple sqrtFixedPoint, dut.count.value *might* work, depending on Verilator's flattening.
