    ...
    \`define MCY' sqrtFixedPoint.v > sqrtFixedPoint_temp.v

    #replace the orginal testbench file with the temp file.
    mv sqrtFixedPoint_temp.v sqrtFixedPoint.v

    # Copy sqrtFixedPoint here
    cp ${PWD}/../../simulation/icarus/sqrtFixedPoint/testbench.v .
