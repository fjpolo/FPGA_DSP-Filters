...
async def counter_test(dut):
    ...
    # This must match the 'limit' passed to FeedbackSupressor() in FeedbackSupressor.py's conversion section
    LIMIT_VAL = 25
    ...
    # If you want to check the count, inspect your FeedbackSupressor.v for the exact path:
    ...
    # For a simple FeedbackSupressor, dut.count.value *might* work, depending on Verilator's flattening.
