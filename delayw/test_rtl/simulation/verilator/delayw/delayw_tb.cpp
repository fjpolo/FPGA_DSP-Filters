...
// Global variable for simulation time, used by the dummy sc_time_stamp()
...
// It returns the current simulation time.
...
int main(int argc, char **argv) {
    ...
    if (failed)
        ...
        // Fix for the warning: use %llu for uint64_t
        printf("\n\nSimulation complete: %llu clocks\n", (unsigned long long)tb.m_tickcount);
        printf("SUCCESS!!\n");
    }

    delete[] mem; // Clean up allocated memory
